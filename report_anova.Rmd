...
Unlike in the original analysis, the interaction between rhythm and tone is only marginally significant when we use the current frequency selection (this is not surprising given the pvalue of 0.04 even in the original analysis).  
...
The same ANOVA using dB-normalized EEG spectra.  
